...
return _1("rosten.widget.ShowDialog",[_3,_4],{templateString:"<div dojoAttachPoint=\"containerNode\"></div>",dialog:null,src:"",onLoadFunction:null,title:"系统对话框",postCreate:function(){
this.dialog=new _5({id:"rosten_showDialog",title:this.title,renderStyles:true},this.containerNode.domNode);
if(this.src==""){
