...
return _1("rosten.widget._Dialog",null,{_dialog:null,height:"320px",width:"350px",id:"system_dialog",contentPane:null,controlPane:null,title:"Dialog_Title",callback:null,queryDlgClose:null,mode:"OKCANCEL",initialized:false,connectArray:[],constructor:function(_a){
for(var _b in _a){
this[_b]=_a[_b];
}
...
this.connectArray.push(_4.connect(this._dialog,"hide",this,function(){
...
_2.forEach(this.connectArray,_4.disconnect);
},open:function(){
...
this.connectArray.push(_4.connect(_f,"onClick",this,"close"));
this.connectArray.push(_4.connect(_e,"onClick",this,"doAction"));
...
this.connectArray.push(_4.connect(_e,"onClick",this,"close"));
_d.appendChild(_e.domNode);
_3.set(_d,"marginRight","auto");
_3.set(_d,"marginLeft","auto");
_3.set(_d,"textAlign","center");
