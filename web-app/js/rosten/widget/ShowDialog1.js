...
return _1("rosten.widget.ShowDialog1",[_3,_4],{templateString:"<div dojoAttachPoint=\"containerNode\"></div>",dialog:null,dlgContentPane:null,src:"",position_absolute_x:200,position_absolute_y:200,callback:null,callbackargs:null,onLoadFunction:null,postCreate:function(){
this.dialog=new _6({id:"rosten_showDialog",renderStyles:true},this.containerNode.domNode);
if(this.src==""){
