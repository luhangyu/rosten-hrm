...
<body>
	<table border="0" width="740" align="left">
		<tr>
		    <td width="120"><div align="right"><span style="color:red">*&nbsp;</span>通讯地址邮编：</div></td>
		    <td width="250">
		 ...
		 <td width="120"><div align="right">固定电话：</div></td>
		  ...
		  <td width="250">
		    	<input id="mobile" data-dojo-type="dijit/form/ValidationTextBox" 
	                 	data-dojo-props='name:"mobile",trim:true,${fieldAcl.isReadOnly("mobile")},
		...
		<tr>
		 <td width="120"><div align="right">家庭地址：</div></td>
		  <td width="250">
		     ...
		     <td width="120"><div align="right">邮编：</div></td>
		  <td width="250">
