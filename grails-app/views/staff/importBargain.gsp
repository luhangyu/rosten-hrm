...
<body>
	<div style="text-Align:center">
           <form data-dojo-type="dijit/form/Form" method="post" class="rosten_form" id="file_form" style="width:560px;text-align:left" 
        	target="upload_iframe" enctype="multipart/form-data" action="${createLink(controller:'staff',action:'importBargainMessage',params:[])}">
            <fieldset class="fieldset-form">
                <legend class="tableHeader">合同批量导入</legend>
